...
class FruitsKkal extends StatefulWidget {
  const FruitsKkal({super.key});

  @override
  State<FruitsKkal> createState() => _FruitsKkalState();
}

class _FruitsKkalState extends State<FruitsKkal> {
  late Future<List<String>> imageUrls;

  @override
  void initState() {
    super.initState();
    imageUrls = StorageService.loadImages('fruit');
  }
